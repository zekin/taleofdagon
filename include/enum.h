      ...
      for (int j=0; j<2000; j++) {
        ...
        switch(height) {
          ...
          switch(temperature_category) {
            case TEMP_COLD: color=0xB38B89; break; //FROZEN WATER CHUNKS
            case TEMP_WARM: color=0xE3716D; break; 
            case TEMP_HOT:  color=0xE3716D; break; //WATER IS WATER MAN, HOT WATER DOESNT CHANGE IT
          } break;
          case ELEVATION_ABOVE_SEA:  
           switch(temperature_category) {
            case TEMP_COLD: color=0xE8EBD1; break; 
            case TEMP_WARM: color=0xB3DFE3; break;
            case TEMP_HOT:  color=0x87C1E0; break;
          } break;
          case ELEVATION_LAND:
          switch(temperature_category) {
            case TEMP_COLD: color=0xFAEDD9; break; //COLD
            case TEMP_WARM: color=0x89E0B0; break; //WARM GRASS/TEMPERATE, FOREST?
            case TEMP_HOT:  color=0x5FABD4; break; //HOT DESERT SAND
          } break;
          case ELEVATION_HIGH_MOUNTAIN: 
          switch(temperature_category) {
            case TEMP_COLD: color=0x606060; break; //ICE MOUNTAIN / TUNDRA
            case TEMP_WARM: color=0x606060; break; //REGULAR MOUNTAIN
            case TEMP_HOT:  color=0x606060; break; //RUGGED CLIFFY MOUNTAIN
          } break;
          default:
            color=0x0;
          break;
...
//        int tile=getTileAt(2000, 2000, j, i);
        ...
        switch (tile.tile_number) {
          case TILE_BEACH_SAND:     color=0xB3DFE3; break;
          case TILE_GRASS:          color=0x89E0B0; break;
          case TILE_MOUNTAIN:       color=0x606060; break;
          case TILE_SAND:           color=0x87C1E0; break;
          case TILE_CRACKED_GROUND: color=0x5FABD4; break;
          case TILE_RIGID_MOUNTAIN: color=0x606060; break;
          case TILE_CRACKED_ICE:    color=0xE8EBD1; break;
          case TILE_SNOW:           color=0xFAEDD9; break;
          case TILE_ICE_MOUNTAIN:   color=0x606060; break;
          case TILE_FROZEN_WATER:   color=0xB38B89; break;
          case TILE_WATER:          color=0xE3716D; break;
          case TILE_CITY_GROUND:    color=0x808080; break;
          case TILE_CITY_WALL:      color=0x303030; break;
          case TILE_CITY_STONE_WALL: color=0xAAAABB; break;
        }
