...
//    }
    ...
    virtual void notify(Event* e) {
        if (e->type==EVENT_PLAY_MUSIC) {
            switch(e->a) {
            case MUSIC_INTRO:
                play_music("Intro", intro);
                break;
            case MUSIC_TOWN:
                play_music("Town", town);
                break;
            case MUSIC_WANDERING:
                play_music("Wandering", wandering);
                break;
            case MUSIC_DESERT:
                play_music("Desert", desert);
                break;
            case MUSIC_FOREST:
                play_music("Forest", forest);
                break;
            case MUSIC_COMBAT1:
                play_music("Combat1", combat1);
                break;
            case MUSIC_COMBAT2:
                play_music("Combat2", combat2);
                break;
            case MUSIC_COMBAT3:
                play_music("Combat3", combat3);
                break;
            case MUSIC_FINALBATTLE:
                play_music("FinalBattle", final_battle);
                break;
            case MUSIC_CREDITS:
                play_music("Credits", credits);
                break;
            default:
