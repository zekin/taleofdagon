...
//    glColor3f(0.5,0.4,0.3);
    ...
    glColor3f(0.7,0.7,0.2); glVertex3f(-0.01,0  ,0);
                            glVertex3f( 1.01,0  ,0);
    glColor3f(0.5,0.4,0.3); glVertex3f( 1.01,0.01,0);   
                            glVertex3f(-0.01,0.01,0);   
                            
    glColor3f(0.5,0.4,0.3); glVertex3f( 1.00,0.01,0);
    glColor3f(0.7,0.7,0.2); glVertex3f( 1.01,0  ,0);
                            glVertex3f( 1.01,1.00,0);   
    glColor3f(0.5,0.4,0.3); glVertex3f( 1.00,0.99,0);   
    
    glColor3f(0.5,0.4,0.3); glVertex3f(-0.01,0.99,0);
                            glVertex3f( 1.00,0.99,0);
    glColor3f(0.7,0.7,0.2); glVertex3f( 1.01,1.00,0);   
                            glVertex3f(-0.01,1.00,0);   
                            
    glColor3f(0.7,0.7,0.2); glVertex3f(-0.01,0   ,0);
    glColor3f(0.5,0.4,0.3); glVertex3f( 0.00,0.01,0);
                            glVertex3f( 0.00,0.99,0);   
    glColor3f(0.7,0.7,0.2); glVertex3f(-0.01,1.00,0);   
    glEnd();
...
//    widgets.push_back(&lblBotPanel);
  ...
  CText* getSkillObject(int skill_number) {
    switch(skill_number) {
      case SKILL_AXES:      return &textbox_skill_axes;
      case SKILL_DODGE:     return &textbox_skill_dodge;
      case SKILL_HEALTH:    return &textbox_skill_health;
      case SKILL_HIDE:      return &textbox_skill_hide;
      case SKILL_MACES:     return &textbox_skill_maces;
      case SKILL_MAGERY:    return &textbox_skill_magery;
      case SKILL_MEDITATE:  return &textbox_skill_meditate;
      case SKILL_SWORDS:    return &textbox_skill_swords;
      default:
        return 0;
    }
  }
  CText* getStatObject(int stat_number) {
    switch(stat_number) {
      case STAT_STR:  return &textbox_stat_strength;
      case STAT_DEX:  return &textbox_stat_dexterity;
      case STAT_INT:  return &textbox_stat_intelligence;
      default:
        return 0;
    }
  }
